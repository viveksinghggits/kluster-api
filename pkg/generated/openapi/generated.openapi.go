...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1.KlsuterStatus": schema_pkg_apis_kluster_v1alpha1_KlsuterStatus(ref),
		"github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1.Kluster":       schema_pkg_apis_kluster_v1alpha1_Kluster(ref),
		"github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1.KlusterList":   schema_pkg_apis_kluster_v1alpha1_KlusterList(ref),
		"github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1.KlusterSpec":   schema_pkg_apis_kluster_v1alpha1_KlusterSpec(ref),
		"github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1.NodePool":      schema_pkg_apis_kluster_v1alpha1_NodePool(ref),
...
func schema_pkg_apis_kluster_v1alpha1_KlsuterStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_pkg_apis_kluster_v1alpha1_Kluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1.KlusterSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1.KlsuterStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1.KlsuterStatus", "github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1.KlusterSpec", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_kluster_v1alpha1_KlusterList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1.Kluster"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1.Kluster", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_kluster_v1alpha1_KlusterSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1.NodePool"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1.NodePool"},
	}
}

func schema_pkg_apis_kluster_v1alpha1_NodePool(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
