...
import (
	...
	apisklusterv1alpha1 "github.com/viveksinghggits/kluster-api/pkg/apis/kluster/v1alpha1"
	versioned "github.com/viveksinghggits/kluster-api/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/viveksinghggits/kluster-api/pkg/generated/informers/externalversions/internalinterfaces"
	klusterv1alpha1 "github.com/viveksinghggits/kluster-api/pkg/generated/listers/kluster/v1alpha1"
...
type KlusterInformer interface {
	...
	Lister() klusterv1alpha1.KlusterLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ViveksinghV1alpha1().Klusters(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ViveksinghV1alpha1().Klusters(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ViveksinghV1alpha1().Klusters(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ViveksinghV1alpha1().Klusters(namespace).Watch(ctx, options)
			},
		}, client),
		&apisklusterv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisklusterv1alpha1.Kluster{}, f.defaultInformer)
}

func (f *klusterInformer) Lister() klusterv1alpha1.KlusterLister {
	return klusterv1alpha1.NewKlusterLister(f.Informer().GetIndexer())
}
